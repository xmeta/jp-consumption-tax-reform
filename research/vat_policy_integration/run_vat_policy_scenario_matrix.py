...
def build():
    ...
    for scenario in scenarios:
        ...
        for idx, source in enumerate(by_regime[scenario["vat_regime_id"]], 1):
            ...
            rows.append({
                ...
                "growth_decline_penalty_effect_status": "NOT_EVALUABLE_WITHOUT_FULL_AGGREGATE_GROWTH_PATH",
                "cumulative_per_capita_real_growth_effect": "",
                "cumulative_per_capita_real_growth_effect_status": "NOT_IDENTIFIED_POLICY_SPECIFIC_REAL_GDP_AND_POPULATION_PATH_REQUIRED",
                "per_capita_growth_decline_penalty_effect": "",
                "per_capita_growth_decline_penalty_effect_status": "NOT_EVALUABLE_WITHOUT_FULL_PER_CAPITA_GROWTH_PATH",
                "median_real_equivalized_disposable_income_effect": "",
                "median_real_equivalized_disposable_income_effect_status": "NOT_IDENTIFIED_OBJECTIVE_RANK_INCIDENCE_AND_HOUSEHOLD_PRICE_PATH_REQUIRED",
                "real_gdp_per_hour_effect": "",
                "real_gdp_per_hour_effect_status": "NOT_IDENTIFIED_FULL_POLICY_OUTPUT_AND_TOTAL_HOURS_PATH_REQUIRED",
    ...
    for scenario in scenarios:
        ...
        summary.append({
            ...
            "cumulative_per_capita_real_growth_status": first["cumulative_per_capita_real_growth_effect_status"],
            "per_capita_growth_decline_penalty_status": first["per_capita_growth_decline_penalty_effect_status"],
            "median_real_equivalized_disposable_income_status": first["median_real_equivalized_disposable_income_effect_status"],
            "real_gdp_per_hour_status": first["real_gdp_per_hour_effect_status"],
