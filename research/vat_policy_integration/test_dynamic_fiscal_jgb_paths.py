...
assert {r["scenario_id"] for r in rows} == {"full_abolition_jgb", "full_abolition_mixed"}
for sid in ("full_abolition_jgb", "full_abolition_mixed"):
...
assert summary["full_abolition_mixed"]["reported_path_assumption_set_id"] == "r02_g02"
...
for sid in ("current_8_10", "full_abolition_income_tax", "full_abolition_asset_tax"):
    ...
    assert summary[sid]["reported_path_assumption_set_id"] == ""
...
print("dynamic fiscal/JGB tests: OK (20 decision-relevant paths; stock-flow identity; 9-set envelope; static benchmark preserved)")
