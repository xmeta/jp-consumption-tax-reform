...
assert int(d["f71561_mother_person_lower_bound"]) == 121_419_541
assert int(d["out_of_mother_domestic_person_upper_bound"]) == 4_726_558
assert int(d["conditional_return_filer_overlap_lower"]) == 18_635_442
assert abs(d["conditional_stage1_filing_rate_lower"] - 0.14772903916751323) < 1e-14
