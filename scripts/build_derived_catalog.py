...
SPECS = [
    ...
    (
        ...
        "JSTAGE-SHIRAISHI-2016-VAT-PASS-THROUGH-POS;BOJ-OUTLOOK-2019-07-CONSUMPTION-TAX;CAO-2014-CONSUMPTION-TAX-DEMAND;MOF-2019-CONSUMPTION-TAX-HIKE;MOF-CONSUMPTION-TAX-RATE-HISTORY;REPEC-CESIFO-2021-GERMANY-TEMP-VAT-CUT;OXFORD-2014-UK-TEMP-VAT-CUT",
        "DERIVED_PASS_THROUGH_AND_QUANTITY_EVIDENCE_NOT_JAPAN_POLICY_PARAMETER",
        "Seven rows separating Japan historical increase evidence and mechanical assumptions from direct external temporary-rate-cut evidence for Germany and the UK; external cut evidence is sensitivity-only and does not identify or bound Japan 5%, 0%, or abolition pass-through",
    ),
    (
        "VAT-RATE-CUT-TRANSPORT-AUDIT",
        "vat_rate_cut_transport_audit.csv",
        "scripts/build_vat_pass_through_evidence.py",
        "MOF-CONSUMPTION-TAX-RATE-HISTORY;JSTAGE-SHIRAISHI-2016-VAT-PASS-THROUGH-POS;REPEC-CESIFO-2021-GERMANY-TEMP-VAT-CUT;OXFORD-2014-UK-TEMP-VAT-CUT",
        "DERIVED_BOUNDED_RATE_CUT_TRANSPORT_AND_STOP_AUDIT",
        "Eight-row audit: no nationwide Japanese standard-rate decrease in the enumerated post-1989 official history, Germany/UK temporary-cut evidence remains external sensitivity, increase-to-decrease symmetry is not adopted, Japan policy pass-through stays NOT_IDENTIFIED, and general public rate-cut evidence accumulation is stopped",
    ),
    (
    ...
    (
        ...
        "ESRI-SNA-2024-NOMINAL-GDP-FISCAL-YEAR;ESRI-SDDSPLUS-GGD-2026Q1;ESRI-SDDSPLUS-GGD-NOTES;MOF-FY2024-TREASURY-REVENUE-2025-07",
        "DERIVED_STATIC_GGD_BASELINE_AND_INCREMENTAL_JGB_FINANCING_SHARE",
        "Eight-scenario static fiscal reference: observed FY2024-end consolidated general-government gross debt is 1,361.0301 trillion yen, or 211.861605907 percent of FY2024 nominal GDP; full-JGB abolition financing remains a separate incremental 3.894868333 percent-of-GDP amount; no future total-debt path is inferred",
    ),
    (
    ...
    "ESRI-SNA-2024-NOMINAL-GDP-FISCAL-YEAR;ESRI-SDDSPLUS-GGD-2026Q1;ESRI-SDDSPLUS-GGD-NOTES;MOF-FY2024-TREASURY-REVENUE-2025-07",
    "MODEL_CONTINGENT_INCREMENTAL_FISCAL_PATH_WITH_OBSERVED_BASELINE",
    "Twenty decision-relevant 10-year stock-flow rows for full-JGB and 50-percent-JGB mixed financing under the committed 2-percent interest / 2-percent nominal-GDP central sensitivity; each carries the observed FY2024-end GGD/GDP baseline, while the modeled path remains incremental policy debt only",
),
(
    ...
    "research/vat_policy_integration/build_dynamic_fiscal_jgb_paths.py",
    "ESRI-SNA-2024-NOMINAL-GDP-FISCAL-YEAR;ESRI-SDDSPLUS-GGD-2026Q1;ESRI-SDDSPLUS-GGD-NOTES;MOF-FY2024-TREASURY-REVENUE-2025-07",
    "MODEL_CONTINGENT_INCREMENTAL_FISCAL_SENSITIVITY_ENVELOPE_WITH_OBSERVED_BASELINE",
    "Eight-scenario summary over nine exogenous interest-rate x nominal-GDP-growth sensitivities; observed FY2024-end GGD/GDP is 211.861605907 percent, while year-10 full-JGB incremental debt/GDP is 27.53--46.76 percent and 50-percent-JGB mixed financing is 13.76--23.38 percent; no future total-debt or endogenous-rate forecast is claimed",
),
    (
        ...
        "MODEL_CONTINGENT_SCENARIO_SCHEMA_MATRIX_WITH_STATIC_REFERENCES",
    ...
    (
        ...
        "research/vat_policy_integration/run_vat_policy_scenario_matrix.py",
        "ESTAT-NSFCW-2024-T1-21-ANNUAL-INCOME-DECILE-EXPENDITURE;ESRI-SNA-2024-NOMINAL-GDP-FISCAL-YEAR;MOF-FY2024-TREASURY-REVENUE-2025-07;JCCI-2024-INVOICE-BACKOFFICE-SURVEY;JCCI-2025-INVOICE-SURVEY;SMEA-FY2025-INVOICE-TRANSACTION-SURVEY-ARCHIVED;ICHIKAWA-ARUDCHELVAN-ONJI-2019-VAT-10M-BUNCHING;RIETI-2019-VAT-COMPLIANCE-FIRM-GROWTH;RIETI-2021-SME-VAT-COMPLIANCE;RIETI-2021-QUANT-TAX-COMPLIANCE-COST;MOF-CONSUMPTION-TAX-SME-EXEMPTION-THRESHOLD;NTA-CONSUMPTION-TAX-BASIC;NTA-INVOICE-SYSTEM-OVERVIEW;JSTAGE-SHIRAISHI-2016-VAT-PASS-THROUGH-POS;BOJ-OUTLOOK-2019-07-CONSUMPTION-TAX;CAO-2014-CONSUMPTION-TAX-DEMAND;MOF-2019-CONSUMPTION-TAX-HIKE",
        "MODEL_CONTINGENT_SCENARIO_SCHEMA_SUMMARY_WITH_STATIC_REFERENCES",
