...
SPECS = [
    ...
    (
        ...
        "Respondent-subset VAT internal-hours mean lower bound 15.126155878468 h/year; uncapped upper bound open due 100+ top code; finite cap rows are stress assumptions, not empirical upper bounds",
    ),
    (
        "VAT-COMPLIANCE-OBSERVED-EVIDENCE",
        "vat_compliance_observed_evidence.csv",
        "scripts/extract_vat_compliance_evidence.py",
        "METI-2021-SME-TAX-SURVEY;JCCI-2024-INVOICE-BACKOFFICE-SURVEY;JCCI-2025-INVOICE-SURVEY;RIETI-2019-VAT-COMPLIANCE-FIRM-GROWTH;RIETI-2021-SME-VAT-COMPLIANCE;RIETI-2021-QUANT-TAX-COMPLIANCE-COST;MOF-CONSUMPTION-TAX-SME-EXEMPTION-THRESHOLD;NTA-CONSUMPTION-TAX-BASIC;NTA-INVOICE-SYSTEM-OVERVIEW",
